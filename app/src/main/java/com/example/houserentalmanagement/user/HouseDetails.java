...
public class HouseDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String phoneNo = intent.getStringExtra("phoneNo");  // Retrieve phone number from intent
        ...
        // Set the house description and image
        tv_houseDesc.setText(houseDescription);
        Glide.with(HouseDetails.this).load(houseImage).into(iv_houseImage);

        // Set up the call button to dial the dynamic phone number
        btn_call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:" + phoneNo));  // Use the dynamic phone number
                startActivity(intent);
            }
        });

        // Set up the message button to send a message to the dynamic phone number

        btn_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent smsIntent = new Intent(Intent.ACTION_VIEW);
                smsIntent.setData(Uri.parse("sms:" + phoneNo));  // Use the dynamic phone number
        ...
        btn_viewLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(HouseDetails.this, HouseDetails.class);
